...
namespace Test1_Problem2
{
    class Program
    {
        ...
        start:
            ...
            int nUnsortedLength = sString.Length;

            aUnsorted = new string[nUnsortedLength];    

            Array.Copy(sString, aUnsorted, aUnsorted.Length);
            ...
            nUnsortedLength = 0;
            foreach (string sThisString in sString)
            {
            ...
            {
                findHiLow = FindLowestValue;
            }
            else
            {
                findHiLow = FindHighestValue;
            }
