...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        RadioButton himRadioButton, herRadioButton, themRadioButton;
        RadioButton froshRadioButton, sophRadioButton, juniorRadioButton, seniorRadioButton;

        GroupBox genderGroupBox, classGroupBox;
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            this.himRadioButton = new RadioButton();
            this.himRadioButton.Name = "himRadioButton";
            this.himRadioButton.Text = "him";
            this.himRadioButton.Location = new Point(454, 53);
            this.himRadioButton.CheckedChanged += new EventHandler(this.RadioButton__CheckedChanged);

            this.herRadioButton = new RadioButton();
            this.herRadioButton.Name = "herRadioButton";
            this.herRadioButton.Text = "Her";
            this.herRadioButton.Location = new Point(454, 78);
            this.herRadioButton.CheckedChanged += new EventHandler(this.RadioButton__CheckedChanged);

            this.themRadioButton = new RadioButton();
            this.themRadioButton.Name = "themRadioButton";
            this.themRadioButton.Text = "Them";
            this.themRadioButton.Location = new Point(454, 103);
            this.themRadioButton.CheckedChanged += new EventHandler(this.RadioButton__CheckedChanged);

            // Add the radio buttons for class
            this.froshRadioButton = new RadioButton();
            this.froshRadioButton.Name = "froshRadioButton";
            this.froshRadioButton.Text = "Freshman";
            this.froshRadioButton.Location = new Point(576, 53);
            this.froshRadioButton.CheckedChanged += new EventHandler(this.RadioButton__CheckedChanged);

            this.sophRadioButton = new RadioButton();
            this.sophRadioButton.Name = "sophRadioButton";
            this.sophRadioButton.Text = "Sophomore";
            this.sophRadioButton.Location = new Point(576, 78);
            this.sophRadioButton.CheckedChanged += new EventHandler(this.RadioButton__CheckedChanged);

            this.juniorRadioButton = new RadioButton();
            this.juniorRadioButton.Name = "juniorRadioButton";
            this.juniorRadioButton.Text = "Junior";
            this.juniorRadioButton.Location = new Point(576, 103);
            this.juniorRadioButton.CheckedChanged += new EventHandler(this.RadioButton__CheckedChanged);

            this.seniorRadioButton = new RadioButton();
            this.seniorRadioButton.Name = "seniorRadioButton";
            this.seniorRadioButton.Text = "Senior";
            this.seniorRadioButton.Location = new Point(576, 128);
            this.seniorRadioButton.CheckedChanged += new EventHandler(this.RadioButton__CheckedChanged);

            // Create the Gender GroupBox
            this.genderGroupBox = new GroupBox();
            this.genderGroupBox.Name = "genderGroupBox";
            this.genderGroupBox.Text = "Gender";
            this.genderGroupBox.Size = new Size(90, 90);
            this.genderGroupBox.Location = new Point(454, 53);
            this.genderGroupBox.TabIndex = 6;

            // Add the gender radio buttons to the Gender GroupBox
            ...
            // Create the Class GroupBox
            this.classGroupBox = new GroupBox();
            this.classGroupBox.Name = "classGroupBox";
            this.classGroupBox.Text = "Class";
            this.classGroupBox.Size = new Size(155, 136);
            this.classGroupBox.Location = new Point(576, 53);
            this.classGroupBox.TabIndex = 7;

            // Add the class radio buttons to the Class GroupBox
            ...
            // Add the Class of Label
            this.classOfLabel = new Label();
            this.classOfLabel.Name = "classOfLabel";
            this.classOfLabel.Text = "Class of 9999";
            this.classOfLabel.Size = new Size(143, 23);
            this.classOfLabel.TextAlign = ContentAlignment.MiddleCenter;
            this.classOfLabel.Location = new Point(576, 192);

            // Add the GroupBoxes and Label to the form
        ...
        private void RadioButton__CheckedChanged(object sender, EventArgs e)
        {
            ...
            if( radioButton.Checked){
                ...
                else if (radioButton == froshRadioButton)
                {
